...
import com.example.bupt.wordsapp.wordcontract.Words;
...
public class WordsDBHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) { //jianshuuku
        sqLiteDatabase.execSQL(SQL_CREATE_DATABASE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) { //数据库升级时被调用，shanchujiubiao
